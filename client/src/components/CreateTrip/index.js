...
export default class CreateTrip extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:3000/trip/add', trip)
    ...
    render() {
        return (
            <div>
               ...
               <p>Add all the places you would like to visit during your trip and don't forget to add those import coffee stops in some local cafes</p>
               <form onSubmit={this.onSubmit}>
                   ...
                   <div className="form-group">
                       <input type="submit" value="Create Trip Plan" className="btn btn-primary" />
                   </div>
               </form>
            </div>
        )
